...
/**
 * Initialization is recommended in your app's Application class.
 * If your project does not have an Application extending class, create one call Taboola.init.. as can be seen in this projects example.
 *
 * Otherwise, there is no code directly related to integration sample code in this class.
 */
