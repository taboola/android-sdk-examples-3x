...
public class SDK_Web_Menu extends AppCompatActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.widgetFeed:
                Intent intent=new Intent(this, SDK_Web.class);
                startActivity(intent);
                break;
            case R.id.splitfeed:
                Intent intent1=new Intent(this, SDK_Web_Split_Feed.class);
